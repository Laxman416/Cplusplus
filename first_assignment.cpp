...
std::tuple<int, int, int, std::string> ask_for_input(int initial_principle_quantum_number, int final_principle_quantum_number,int  atomic_number, std::string output_units)
{
  ...
  while (!(std::cin>>atomic_number) || atomic_number <= 0) // while atomic number gives an error or is less than 0 reruns
  {
  ...
  while (!(std::cin>>initial_principle_quantum_number) || initial_principle_quantum_number <= 0) 
  {
  ...
  while (!(std::cin>>final_principle_quantum_number) || final_principle_quantum_number <= 0 || final_principle_quantum_number > initial_principle_quantum_number)
  {
    if (final_principle_quantum_number > initial_principle_quantum_number) 
    {
  ...
  while (!(std::cin>>output_units) || output_units != "J" && output_units != "eV")
  {
  ...
  return std::make_tuple(atomic_number, initial_principle_quantum_number, final_principle_quantum_number, output_units); 
}
